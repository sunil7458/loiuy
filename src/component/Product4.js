...
const Product4 = ({ plpimaage, title, price, name }) => {
...
name : name
  ...
  return (
    <div className="p-2  flex justify-center">
      <div className="bg-[#141414] lg:w-[70%] w-full  text-white rounded-md">
        ...
        <div className="text-[13px] p-1 text-white">{name}</div>
        <div className="flex  justify-between p-1 ">
          <div className="flex text-[14px]  items-center  space-x-2 p-1">
            ...
            <del className="md:text-[13px] text-[8px]  ">{price}</del>
