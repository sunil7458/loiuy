...
const Product1 = ({ plpimaage, name, price, price_usd }) => {
  ...
  return (
    <>
      <div className="bg-[#141414] lg:w-[90%] w-full   text-white  rounded-md">
        <div className="flex text-white  ">
          <Link to="/buy" className="w-full">
            <img
              src={plpimaage}
              alt="lkj"
              className=" object-cover w-full xl:h-[50vh] "
            />
          </Link>
          <svg
            className="absolute"
        ...
        <div className="text-[13px] p-1">{name}</div>
        <div className="flex  justify-between p-1 ">
          <div className="flex text-[14px]  items-center  space-x-2 p-1">
            ...
            <span>{price}</span>
            <del className="text-[13px] ">{price}</del>

            <span className="text-[12px] text-green-500">{price_usd}% off</span>
          </div>
          <div className="relative mb-6">
            ...
            {basket?.filter((data) => data?.name === name)?.length ? (
